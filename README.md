# test-swagger OpenAPI Specification
[![Build Status](https://travis-ci.org/r0h17/test-swagger.svg?branch=master)](https://travis-ci.org/r0h17/test-swagger)
...
6. If you did everything correct, https://r0h17.github.io/test-swagger/ will lead to your new docs
...
- Documentation(ReDoc): https://r0h17.github.io/test-swagger/
- SwaggerUI: https://r0h17.github.io/test-swagger/swagger-ui/
- Look full spec:
    + JSON https://r0h17.github.io/test-swagger/swagger.json
    + YAML https://r0h17.github.io/test-swagger/swagger.yaml
- Preview spec version for branch `[branch]`: https://r0h17.github.io/test-swagger/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://r0h17.github.io/test-swagger/ with url from the message: `Server started <url>`
